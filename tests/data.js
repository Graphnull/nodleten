...
module.exports.IRIS_CLASSES = IRIS_CLASSES
const IRIS_NUM_CLASSES = IRIS_CLASSES.length;
module.exports.IRIS_NUM_CLASSES = IRIS_NUM_CLASSES
const IRIS_NUM_FEATURES = 4;
module.exports.IRIS_NUM_FEATURES = IRIS_NUM_FEATURES
...
module.exports.IRIS_RAW_DATA = IRIS_RAW_DATA;
/**
...
module.exports.flatOneHot = flatOneHot;
/**
 ...
 */
module.exports.getIrisData = async function getIrisData(testSplit) {
